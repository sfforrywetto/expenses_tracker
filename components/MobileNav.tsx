        ...
        <Sheet>
            ...
            <SheetContent side='left' className='border-none bg-white'>
                <Link href="/" className='cursor-pointer items-center gap-1 px-4'>
                    <Image src='/icons/logo.svg' width={34} height={34} alt='hl'/>
                    <h1 className='text-26 font-ibm-plex-serif font-bold text-black-1'>ExTr_Prof</h1>
                </Link>
                                ...
                                return(
                                    <SheetClose asChild key={i.route}>
                                        <Link href={i.route} key={i.label} className={cn('mobilenav-sheet_close w-full', {'bg-bank-gradient': isActive})}>
                                            ...
                                            <Image src={i.imgURL} alt={i.label} width={20} height={20} className={cn({
